...
public interface HCNetSDK extends StdCallLibrary {
    ...
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary("hk_sdk\\HCNetSDK", HCNetSDK.class);
    /***宏定义***/
    //常量
...
//JPEG抓图到内存
 boolean  NET_DVR_CaptureJPEGPicture_NEW(NativeLong lUserID, NativeLong lChannel, NET_DVR_JPEGPARA lpJpegPara, byte[] sJpegPicBuffer, int dwPicSize, IntByReference lpSizeReturned);
...
{
    PlayCtrl INSTANCE = (PlayCtrl) Native.loadLibrary("hk_sdk\\PlayCtrl", PlayCtrl.class);
...
{
    GDI32 INSTANCE = (GDI32) Native.loadLibrary("hk_sdk\\gdi32", GDI32.class, DEFAULT_OPTIONS);
...
{
    USER32 INSTANCE = (USER32) Native.loadLibrary("hk_sdk\\user32", USER32.class, DEFAULT_OPTIONS);
